...
2. Send a detailed report to the repository maintainer via:
   - GitHub Security Advisory: [Report a vulnerability](https://github.com/MobileTeleSystems/logs/security/advisories/new)
   - Email: Create an issue in the [issue tracker](https://github.com/MobileTeleSystems/logs/issues) marked as **Security** (if no sensitive details need to be shared)
...
- **Version**: The version of `logs` affected
...
- Open a [GitHub Security Advisory](https://github.com/MobileTeleSystems/logs/security/advisories/new)
